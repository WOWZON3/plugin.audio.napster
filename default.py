...
def CATEGORIES():
    addDir('Artists','http://musicmp3.ru/artists.html',21,art + 'icon.png','')
    addDir('Top Albums','http://musicmp3.ru/genres.html',12,art + 'icon.png','')
    addDir('New Albums','http://musicmp3.ru/new_albums.html',12,art + 'icon.png','')
    addDir('Compilations','url',400,'','')
    addDir('Billboard Charts','url',101,art + 'icon.png','')
    addDir('Search Artists','url',24,art + 'icon.png','')
    addDir('Search Albums','url',24,art + 'icon.png','')
    addDir('Search Songs','url',24,art + 'icon.png','')
    addDir('Favourite Artists','url',63,art + 'icon.png','')
    addDir('Favourite Albums','url',66,art + 'icon.png','')
    addDir('Favourite Songs','url',69,art + 'icon.png','')
    addDirAudio('Instant Mix Favourite Songs (Shuffle and Play)','url',99,art + 'icon.png','','','','','')
    addDirAudio('Instant Mix Favourite Albums (Shuffle and Play)','url',89,art + 'icon.png','','','','','')
    addDirAudio('Clear Playlist','url',100,art + 'icon.png','','','','','')
    addDirAudio('Add ID3 Tags','url',300,art + 'icon.png','','','','','')
    addDir('Browse Alternate Source','url',700,artgenre + 'icon.png','')

def charts():
    addDir('BillBoard Hot 20 Singles','http://www.officialcharts.com/charts/billboard-hot-100-chart/',102,artbillboard +'icon.png','')
    addDir('BillBoard 20 Albums','http://www.officialcharts.com/charts/billboard-200/',102,artbillboard +'icon.png','')
    addDir('Top 100 Streaming Singles','http://www.officialcharts.com/charts/audio-streaming-chart/',102,artbillboard +'icon.png','')
    addDir('Top 100 UK Singles','http://www.officialcharts.com/charts/singles-chart/',102,artbillboard +'icon.png','')
    addDir('Top 100 UK Albums','http://www.officialcharts.com/charts/albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 100 End of Year Singles','http://www.officialcharts.com/charts/end-of-year-singles-chart/',102,artbillboard +'icon.png','')
    addDir('Top 100 End of Year Albums','http://www.officialcharts.com/charts/end-of-year-artist-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 100 Compilation Albums','http://www.officialcharts.com/charts/official-compilations-chart/',102,artbillboard +'icon.png','')
    addDir('Top 50 Soundtracks','http://www.officialcharts.com/charts/soundtrack-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 40 Dance Singles','http://www.officialcharts.com/charts/dance-singles-chart/',102,artbillboard +'icon.png','')
    addDir('Top 40 Dance Albums','http://www.officialcharts.com/charts/dance-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 40 R&B Singles','http://www.officialcharts.com/charts/r-and-b-singles-chart/',102,artbillboard +'icon.png','')
    addDir('Top 40 R&B Albums','http://www.officialcharts.com/charts/r-and-b-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 40 Rock/Metal Singles','http://www.officialcharts.com/charts/rock-and-metal-singles-chart/',102,artbillboard +'icon.png','')
    addDir('Top 40 Rock/Metal Albums','http://www.officialcharts.com/charts/rock-and-metal-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 50 Independent Singles','http://www.officialcharts.com/charts/independent-singles-chart/',102,artbillboard +'icon.png','')
    addDir('Top 50 Independent Albums','http://www.officialcharts.com/charts/independent-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 20 Country Albums','http://www.officialcharts.com/charts/country-artists-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 20 Country Compilation Albums','http://www.officialcharts.com/charts/country-compilations-chart/',102,artbillboard +'icon.png','')
    addDir('Top 50 Classical Compilation Albums','http://www.officialcharts.com/charts/classical-compilation-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 30 Jazz & Blues Albums','http://www.officialcharts.com/charts/jazz-and-blues-albums-chart/',102,artbillboard +'icon.png','')
    addDir('Top 20 Christian & Gospel Albums','http://www.officialcharts.com/charts/christian-and-gospel-albums-chart/',102,artbillboard +'icon.png','')
    #addDir('UK Album Chart','http://www.billboard.com/charts/united-kingdom-albums',102,artbillboard +'icon.png','')
    #addDir('UK Single Chart - Top 100','http://www.officialcharts.com/singles-chart/',102,artbillboard +'icon.png','')
    #addDir('BillBoard 200','http://www.officialcharts.com/charts/billboard-200/',102,artbillboard +'icon.png','')
    #addDir('Hot 100 Singles','http://www.billboard.com/charts/hot-100',102,artbillboard +'icon.png','')
    #addDir('Country Albums','http://www.billboard.com/charts/country-albums',102,artbillboard +'icon.png','')
    #addDir('HeatSeeker Albums','http://www.billboard.com/charts/heatseekers-albums',102,artbillboard +'icon.png','')
    #addDir('Independent Albums','http://www.billboard.com/charts/independent-albums',102,artbillboard +'icon.png','')
    #addDir('Catalogue Albums','http://www.billboard.com/charts/catalog-albums',102,artbillboard +'icon.png','')
    #addDir('Folk Albums','http://www.billboard.com/charts/folk-albums',102,artbillboard +'icon.png','')
    #addDir('Blues Albums','http://www.billboard.com/charts/blues-albums',102,artbillboard +'icon.png','')
    #addDir('Tastemaker Albums','http://www.billboard.com/charts/tastemaker-albums',102,artbillboard +'icon.png','')
    #addDir('Rock Albums','http://www.billboard.com/charts/rock-albums',102,artbillboard +'icon.png','')
    #addDir('Alternative Albums','http://www.billboard.com/charts/alternative-albums',102,artbillboard +'icon.png','')
    #addDir('Hard Rock Albums','http://www.billboard.com/charts/hard-rock-albums',102,artbillboard +'icon.png','')
    #addDir('Digital Albums','http://www.billboard.com/charts/digital-albums',102,artbillboard +'icon.png','')
    #addDir('R&B Albums','http://www.billboard.com/charts/r-b-hip-hop-albums',102,artbillboard +'icon.png','')
    #addDir('Top R&B/Hip-Hop Albums','http://www.billboard.com/charts/r-and-b-albums',102,artbillboard +'icon.png','')
    #addDir('Dance Electronic Albums','http://www.billboard.com/charts/dance-electronic-albums',102,artbillboard +'icon.png','')
...
def compilations_menu():
    addDir('Best Compilations','http://www.goldenmp3.ru/albums_showcase.html?section=compilations&type=albums&page=',401,art + 'icon.png','1')
    addDir('New Compilations','http://www.goldenmp3.ru/albums_showcase.html?section=compilations&sort=new&type=albums&page=',401,art + 'icon.png','1')
    addDir('Major Hits','http://www.goldenmp3.ru/albums_showcase.html?gnr_id=806&section=compilations&type=albums&page=',401,art + 'icon.png','1')
    addDir('Nightclub Hits','http://www.goldenmp3.ru/albums_showcase.html?gnr_id=822&section=compilations&type=albums&page=',401,art + 'icon.png','1')
    addDir('Chillout Hits','http://www.goldenmp3.ru/albums_showcase.html?gnr_id=848&section=compilations&type=albums&page=',401,art + 'icon.png','1')
    addDir('Tributes and Covers','http://www.goldenmp3.ru/albums_showcase.html?gnr_id=872&section=compilations&type=albums&page=',401,art + 'icon.png','1')
